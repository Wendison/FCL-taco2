...
class CustomEvaluator(BaseEvaluator):
    ...
    def __init__(self, teacher_model, student_model, iterator, target, device):
        """Initilize module.
    ...
    def evaluate(self):
        ...
        with torch.no_grad():
            for batch in it:
                ...
                teacher_knowledge = self.teacher_model(**x)
                x['teacher_knowledge'] = teacher_knowledge
                observation = {}
...
class CustomUpdater(training.StandardUpdater):
    ...
    def __init__(self, teacher_model, student_model, grad_clip, iterator, optimizer, device, accum_grad=1, use_amp=False, num_batches=None, outdir=None):
        """Initilize module.
