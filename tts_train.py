...
def get_parser():
    ...
    parser.add_argument(
        ...
        default=False,
        type=strtobool,
        help="whether use amp for speeding up training",
    )
    parser.add_argument(
        "--amp-checkpoint",
        default=None,
        type=str,
        help="amp checkpoint for initialization to continue training when using amp for training",
    )
    parser.add_argument(
        "--encoder-resume",
        default=None,
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="teacher config for knowledge distillation",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=True,
        type=strtobool,
        help="whether to distill decoder knowledge",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=True,
        type=strtobool,
        help="whether to train during KD",
    )
    parser.add_argument(
        "--share-proj",
        default=False,
        type=strtobool,
        help="whether to share proj-layers for student-model during KD",
    )
    parser.add_argument(
        "--perform-KD",
        default=False,
...
def main(cmd_args):
    ...
    if not args.perform_KD:
        from tts import train
        train(args)
    else:
        from tts_distill import train
        train(args, teacher_args)
